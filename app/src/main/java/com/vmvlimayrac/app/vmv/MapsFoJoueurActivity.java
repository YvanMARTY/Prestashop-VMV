...
public class MapsFoJoueurActivity extends FragmentActivity implements GetResultQuery, OnMapReadyCallback {
    ...
    public JSONArray loadJson(String json) throws JSONException {
        JSONArray jsonArray = new JSONArray(json);
            ...
            public void onMapReady(final GoogleMap googleMap) {
                ...
                new MapsFoJoueurActivity().downloadJSON("https://visite-ma-ville.fr/external/external_app.php",this,googleMap);
