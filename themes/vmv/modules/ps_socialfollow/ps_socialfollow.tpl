    ...
    <ul class="laber-media-body">
      {foreach from=$social_links item='social_link'}
		{if $social_link.class == facebook}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-facebook"></i></a></li>
		{/if}
		{if $social_link.class == twitter}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-twitter"></i></a></li>
		{/if}
		{if $social_link.class == rss}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-rss"></i></a></li>
		{/if}
		{if $social_link.class == youtube}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-youtube"></i></a></li>
		{/if}
		{if $social_link.class == googleplus}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-google-plus"></i></a></li>
		{/if}
		{if $social_link.class == pinterest}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-pinterest-p"></i></a></li>
		{/if}
		{if $social_link.class == vimeo}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-vimeo"></i></a></li>
		{/if}
		{if $social_link.class == instagram}
			<li class="pull-left laber-{$social_link.class}"><a href="{$social_link.url}" title="{$social_link.label}" target="_blank"><i class="fa fa-instagram"></i></a></li>
		{/if}
      {/foreach}
    </ul>
  </div>
